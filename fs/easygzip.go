...
func EasyUnGzip(filename string) (string, error) {
	...
	// Create a new file without .gz extension
	decompressedFilePath := strings.TrimSuffix(filename, filepath.Ext(filename))
	...
	// Use gzip reader to decompress the file
	...
	// Copy the content of the gzip reader to the decompressed file
